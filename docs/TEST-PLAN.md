...
| IT-AUTH-07 | 邮件发送频率限制 | POST | `/auth/send-register-code` × 2 (间隔 < 60s) | 42901(第二次) |
...
| 模块 | 最低行覆盖率 | 生成方式 |
|------|:----------:|---------|
| zhiyu-common | 90% | JaCoCo |
| zhiyu-auth | 85% | JaCoCo |
| zhiyu-user | 80% | JaCoCo |
| zhiyu-subscription | 80% | JaCoCo |
| zhiyu-admin | 80% | JaCoCo |
